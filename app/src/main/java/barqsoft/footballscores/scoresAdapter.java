...
public class ScoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        mHolder.home_name.setText(cursor.getString(cursor.getColumnIndex(ScoreContract.ScoreColumn.HOME_COL)));
        mHolder.away_name.setText(cursor.getString(cursor.getColumnIndex(ScoreContract.ScoreColumn.AWAY_COL)));
        mHolder.date.setText(cursor.getString(cursor.getColumnIndex(ScoreContract.ScoreColumn.TIME_COL)));
        ...
        if(mHolder.match_id == detail_match_id)
        {
            ...
            match_day.setText(Utilities.getMatchDay(
                    cursor.getInt(cursor.getColumnIndex(ScoreContract.ScoreColumn.MATCH_DAY)),
